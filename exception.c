...
struct Error MemoryError = { .message = "Can't allocate memory for JSON_OBJECT", .code = 4};
struct Error MaxKeysInObjectLimitException = { .message = "Too many keys in JSON_OBJECT", .code = 5};
